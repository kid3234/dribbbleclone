...
const Navbar: React.FC<myprops> = ({ isAtMiddle }) => {
  ...
  const [showExplorelarge, setShowExplorelarge] = useState(true);
  const [showHiredesinerlarge, setShowHiredesinerlarge] = useState(true);
  ...
  const openShowExplore = () => {
    setShowExplorelarge(true); // Toggle state
          ...
          <div className="w-full flex  items-center gap-10">
            ...
            >
              ...
              {isAtMiddle && isLargeScreen ? (
                <div className="relative w-3/4  hover:bg-white bg-gray-100 rounded-full flex items-center">
                  <input
                    type="text"
                    placeholder="What are you looking for?"
                    className="focus:outline-none focus:border-[#ec5fa1] focus:bg-white px-8 py-3 rounded-full focus:ring-0 bg-inherit  w-full border"
                  />
            ...
            {isLargeScreen ? (
              <div className="w-3/4 flex items-center gap-8 ">
                <div className="relative font-semibold  text-sm ">
                  ...
                  {showExplorelarge ? (
                    <div>
                      ...
                      ></div>
                      <div className=" absolute top-6 left-0 w-52 flex flex-col gap-4 shadow-lg z-40 bg-white rounded-lg px-4 py-2">
                ...
                <div className="relative font-semibold  text-sm ">
                  <div
                    onMouseOver={openShowHiredesiner}
                    className="flex items-center gap-2 cursor-pointer  hover:text-gray-600"
                  >
                    <p>Hire a Designer</p>
                    <Icon icon="lsicon:down-outline" width="20" height="20" />
                  ...
                  {showHiredesinerlarge ? (
                    <div>
                      <div
                        onMouseOver={closeShowHiredesiner}
                        className="w-full h-screen fixed inset-0 z-10 bg-opacity-50 pt-4"
                      ></div>
